            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="/chiefWardenStaffs/login" accept-charset="UTF-8" id="loginForm">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    ...
                                    <a class="btn btn-link" href="/chiefWardenStaffs/password/reset">Forgot Your Password?</a>
                                </div>
                            </div>
                        </form>
                    </div>

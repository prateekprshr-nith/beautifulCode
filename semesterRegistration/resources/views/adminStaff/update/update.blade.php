            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" role="form" method="POST" action="/adminStaffs/updateInfo/info"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input required class="form-control" name="email" type="text"
                                           id="email" value="{{$adminStaff->email}}">
                                </div>
                                <div class="col-md-2">
                                    <button class="btn btn-primary" type="submit" id="UpdateButton">
                                        <span class="glyphicon glyphicon-edit"></span> Submit
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="/adminStaffs/updateInfo/password"

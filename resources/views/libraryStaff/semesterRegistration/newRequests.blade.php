...
@section('content')
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-tabs nav-justified">
                            <li role="presentation" class="active">
                                <a href="/libraryStaffs/semesterRegistration/studentRequests/new">
                                    New Requests <span class="badge">{{$requestCount['newCount']}}</span>
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="/libraryStaffs/semesterRegistration/studentRequests/pending">
                                    Pending Requests <span class="badge">{{$requestCount['pendingCount']}}</span>
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="/libraryStaffs/semesterRegistration/studentRequests/approved">
                            ...
                            <tbody>
                                @foreach ($requests as $request)
                                    <tr>
                                        ...
                                        <td>
                                            <form method="post" action="/libraryStaffs/semesterRegistration/studentRequests/approve">
                                                {{method_field('PATCH')}}
                                                {{csrf_field()}}
                                        ...
                                        <form method="post" action="/libraryStaffs/semesterRegistration/studentRequests/hold">
                                            {{method_field('PATCH')}}
                                            {{csrf_field()}}
    ...
    @include('libraryStaff.partials.studentAndFeeInformationModal')

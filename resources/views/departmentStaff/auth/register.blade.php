@extends('admin.manage.departmentStaffs')

@section('departmentStaffRegPanel')
    <div class="container col-sm-offset-2 col-sm-8">
        <div class="panel panel-default">
            <div class="panel-heading">
                <span class="glyphicon glyphicon-plus"></span>
                <strong> Add a new department staff member</strong>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" action="/departmentStaffs/register"

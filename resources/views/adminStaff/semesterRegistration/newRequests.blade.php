...
@section('content')
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-tabs nav-justified">
                            <li role="presentation" class="active">
                                <a href="/adminStaffs/semesterRegistration/studentRequests/new">
                                    New Requests <span class="badge">{{$requestCount['newCount']}}</span>
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="/adminStaffs/semesterRegistration/studentRequests/pending">
                                    Pending Requests <span class="badge">{{$requestCount['pendingCount']}}</span>
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="/adminStaffs/semesterRegistration/studentRequests/approved">
                            ...
                            <tbody>
                                @foreach ($requests as $request)
                                    <tr>
                                        ...
                                        <form method="post" action="/adminStaffs/semesterRegistration/studentRequests/hold">
                                            {{method_field('PATCH')}}
                                            {{csrf_field()}}
    ...
    @include('adminStaff.partials.studentAndFeeInformationModal')
